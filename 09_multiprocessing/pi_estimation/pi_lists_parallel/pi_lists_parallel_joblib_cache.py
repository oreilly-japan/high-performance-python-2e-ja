...
from pi_lists_parallel import (
    estimate_nbr_points_in_quarter_circle as estimate_nbr_points_in_quarter_circle_orig,
)
...
if __name__ == "__main__":
    ...
    nbr_in_quarter_unit_circles = Parallel(n_jobs=nbr_parallel_blocks)(
        delayed(estimate_nbr_points_in_quarter_circle_with_idx)(nbr_samples_per_worker, idx)
        for idx in range(nbr_parallel_blocks)
    )
